...
ult_ent_origem as (
  ...
  tdap.id_escola_sige,
  cd_ano_serie 
  from public.tb_cubo_aluno_junho_2024 tdap 
  left join academico.tb_auditoria_aluno_mesclar taam on taam.cd_aluno_excluido  = tdap.cd_aluno 
  join public.tb_dm_aluno_pessoa_2024_06_01 p on p.cd_aluno = tdap.cd_aluno 
...
case when tde.cd_modalidade in (36,40) then 'Regular'
 ...
 join academico.tb_turma tor on tor.ci_turma = eo.cd_turma and tor.nr_anoletivo = 2024
