drop table if exists tmp.tb_frequencias_t;
create table tmp.tb_frequencias_t as (
with 
disciplinas as (
select 
ci_disciplina,
...
,turmas as (
  ...
  where nr_anoletivo in (2023,2024)
  and cd_prefeitura = 0
  and cd_nivel = 27
...
,enturmados as (
  ...
  where e.nr_anoletivo in (2023,2024)
...
left join tmp.tb_frequencias_t  f on a.cd_turma=f.cd_turma 
