...
where 
-- tpc.no_pessoa_fisica ilike 'Douglas Ferreira Paiva' 
-- and tpc.dt_nascimento ilike '%1985'
 co_pessoa_fisica = 114302858000
-- tpc.nu_cpf = 00743740360
--group by 2,3,4,5,6
),
mat as (
select 
...
where
exists(select 1 from busca b where b.co_pessoa_fisica = tm.co_pessoa_fisica ) 
