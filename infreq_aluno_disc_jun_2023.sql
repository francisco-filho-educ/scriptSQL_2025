...
from public.tb_infrequencia_aluno_disc_2023_jun i
...
join ( select cd_etapa, cd_newetapa, ds_newetapa ds_etapa, ds_nivel  from academico.tb_etapa_etapamodalidade group by 1,2,3,4 ) as tee on tee.cd_etapa = tm.cd_etapa
