with
  ...
  where fl_tipo_atividade = 'RG' and nr_anoletivo = 2024 -- ANO LETIVO AVALIADO
  and exists (
  ...
  where te.nr_anoletivo = 2024  -- ANO LETIVO AVALIADO
  ...
  where tm.dt_criacao::date > ('2024-05-30')::date and ((cd_situacao = 1 AND cd_motivo = 1) OR (cd_situacao = 3 AND fl_motivo_cancelamento = 'DF'))
