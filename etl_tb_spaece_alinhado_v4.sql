...
lp.nm_turma,--
3 cd_etapa_ceipe,
lp.cd_etapa_aplicacao_turma::int,
lp.dc_etapa_aplicacao_turma,
lp.cd_etapa_avaliada_turma::int,
lp.dc_etapa_avaliada_turma,
' - ENSINO MEDIO' ds_etapa_serie_tabela, -- identificacao da serie/etapa atraves do nome original da tabela
lp.cd_aluno,
lp.cd_aluno_inep,
lp.cd_aluno_institucional,
...
lp.nm_turma,--
2 cd_etapa_ceipe,
lp.cd_etapa_divulgacao_turma::int cd_etapa_aplicacao_turma,
lp.dc_etapa_divulgacao_turma dc_etapa_aplicacao_turma,
lp.cd_etapa_turma::int cd_etapa_avaliada_turma,
lp.dc_etapa_turma dc_etapa_avaliada_turma,
'5 ANO - ENSINO FUNDAMENTAL' ds_etapa_serie_tabela, -- identificacao da serie/etapa atraves do nome original da tabela
lp.cd_aluno::text,
NULL cd_aluno_inep,
...
lp.nm_turma,--
2 cd_etapa_ceipe,
lp.cd_etapa_turma::int cd_etapa_aplicacao_turma,
lp.dc_etapa_turma dc_etapa_aplicacao_turma,
lp.cd_etapa_divulgacao_turma::int cd_etapa_avaliada_turma,
lp.dc_etapa_divulgacao_turma dc_etapa_avaliada_turma,
'9 ANO - ENSINO FUNDAMENTAL' ds_etapa_serie_tabela, -- identificacao da serie/etapa atraves do nome original da tabela
lp.cd_aluno::text,
NULL cd_aluno_inep,
NULL cd_aluno_institucional,
...
lp.nm_turma,--
2 cd_etapa_ceipe,
lp.cd_etapa::int cd_etapa_aplicacao_turma,
lp.dc_etapa dc_etapa_aplicacao_turma,
NULL cd_etapa_avaliada_turma,
NULL dc_etapa_avaliada_turma,
' - ENSINO FUNDAMENTAL' ds_etapa_serie_tabela, -- identificacao da serie/etapa atraves do nome original da tabela
lp.cd_aluno::text,
lp.cd_aluno::text cd_aluno_inep,
lp.cd_aluno::text cd_aluno_institucional,
