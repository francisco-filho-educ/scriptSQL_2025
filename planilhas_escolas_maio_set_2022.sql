...
case when tt.cd_etapa_sige = 180 then 0
     when tt.cd_etapa_sige = 181 then 1
     when tt.cd_etapa_sige = 177 then 2
     when tt.cd_etapa_sige = 121 then 3 
     when tt.cd_etapa_sige = 122 then 4 
     when tt.cd_etapa_sige = 123 then 5 
     when tt.cd_etapa_sige = 124 then 6 
     when tt.cd_etapa_sige = 125 then 7 
     when tt.cd_etapa_sige = 126 then 8 
     when tt.cd_etapa_sige = 127 then 9 
     when tt.cd_etapa_sige = 128 then 10 
     when tt.cd_etapa_sige = 129 then 11
     when tt.cd_etapa_sige = 183 and tt.cd_nivel  =  26 then  12
...
case when tt.cd_etapa_sige = 180 then  'Creche'
     when tt.cd_etapa_sige = 181 then  'Pré-escola'
     when tt.cd_etapa_sige = 177 then  'Multietapa'
