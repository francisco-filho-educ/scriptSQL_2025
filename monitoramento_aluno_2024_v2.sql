...
case when ta.fl_transporte = 'S' then 'SIM' else 'NÃO' end ds_transporte
...
inner join aluno a on ci_aluno = et.cd_aluno
...
--select ds_etapa, count(1) cont, count(distinct cd_aluno)  from relatorio group by 1
