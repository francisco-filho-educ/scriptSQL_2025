...
case when cd_raca is null then 6 else cd_raca end cd_raca,
...
where exists (select 1 from public.tb_dm_etapa_aluno/*_2023_03_17*/ et where et.cd_aluno = ci_aluno) -- VERIFICAR data DE INSERCAO
